  ...
  <div class="mbox sp">
    ...
    <div class="mbody">
      ...
      <form id="spreadForm" enctype="multipart/form-data">
        ...
        <div class="count-row">
          <label><i class="fas fa-layer-group" style="margin-right:4px;opacity:.6"></i>Count:</label>
          ...
          <span class="count-hint" id="sp-count-hint">5 files — max 50</span>
        </div>
...
function syncCount(src){
  ...
  document.getElementById('sp-count-hint').innerHTML=(v===1?'1 file':v+' files')+' — max 50';
}
...
function closeSpread(){
  ...
  $('#sp-count-hint').html('5 files — max 50'); $('#spRootHint').html(''); $('#spLog').hide(); $('#spLogItems').html('');
